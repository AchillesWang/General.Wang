...
@interface NTAppDelegate ()<UITabBarControllerDelegate,UIViewControllerAnimatedTransitioning,UIGestureRecognizerDelegate>
...
@property (nonatomic,strong) UIScreenEdgePanGestureRecognizer* leftEdge;
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    tbc.delegate = self;
    //手势
    UIScreenEdgePanGestureRecognizer* sep = [[UIScreenEdgePanGestureRecognizer alloc]initWithTarget:self
                                                                                             action:@selector(pan:)];
...
-(BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    UITabBarController* tbc = (UITabBarController*)self.window.rootViewController;
    BOOL result = NO;
    if (gestureRecognizer == self.rightEdge) {
